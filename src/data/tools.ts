...
export const TOOL_GROUPS: ToolGroup[] = [
  {
    ...
    tools: [
      ...
      { id: "ocr",          to: "/ocr",          icon: Search,     title: "OCR Reader",      description: "External OCR processing: extract text from PDFs and images with OpenRouter-backed OCR.",             colorClass: "bg-violet-600",  shortDesc: "Extract text from scanned PDFs and images", category: "pdf", processing: "external", requiresExternalDependency: true },
