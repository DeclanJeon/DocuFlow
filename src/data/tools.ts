...
export const TOOL_GROUPS: ToolGroup[] = [
  {
    ...
    tools: [
      ...
      { id: "ocr",          to: "/ocr",          icon: Search,     title: "OCR Reader",      description: "Server processing: extract text from scanned PDFs and images with internal Tesseract OCR.",                  colorClass: "bg-violet-600",  shortDesc: "Internal OCR for scanned PDFs and images", category: "pdf", processing: "server", requiresServer: true },
  ...
  },
  {
    ...
    tools: [
      ...
      { id: "pdf-to-md",   to: "/pdf-to-md",   icon: FileText, title: "PDF to Markdown", description: "pdf-inspector layout-aware extraction — text PDFs become Markdown without OCR.", colorClass: "bg-purple-600",  shortDesc: "Layout-aware PDF to Markdown (no OCR needed)", category: "conversion", processing: "server", requiresServer: true },
